    ...
    <section className="section-container bg-white min-h-screen flex items-center">
      <div className="text-center max-w-4xl mx-auto">
        ...
        <p className="text-xl text-gray-600 mb-8 leading-relaxed">
          Information Systems student specializing in Business Analytics and AI, passionate about 
          creating innovative solutions that bridge technology and business impact.
        </p>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid-3 mb-12">
          ...
          <div className="professional-card text-center">
            ...
            <p className="text-sm mb-3" style={{ color: 'var(--color-text-secondary)' }}>Cheanweijie02@gmail.com</p>
            <a 
          ...
          <div className="professional-card text-center">
            ...
            <h3 className="font-semibold mb-2" style={{ color: 'var(--color-text-primary)' }}>LinkedIn</h3>
            <p className="text-sm mb-3" style={{ color: 'var(--color-text-secondary)' }}>Professional Network</p>
            <a 
          ...
          <div className="professional-card text-center">
            ...
            <h3 className="font-semibold mb-2" style={{ color: 'var(--color-text-primary)' }}>Phone</h3>
            <p className="text-sm mb-3" style={{ color: 'var(--color-text-secondary)' }}>+65 8358 2090</p>
            <p className="text-xs" style={{ color: 'var(--color-text-muted)' }}>Available in Singapore</p>
          </div>
        </div>
        ...
        <div className="professional-card text-center" style={{
          ...
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <h4 className="font-semibold" style={{ color: 'var(--color-text-primary)' }}>Available for Internships</h4>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-gray-400">
              © 2025 Chean Wei Jie. Built with passion and modern web technologies.
            </p>
          </div>
        </div>
      </footer>
